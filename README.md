### H2O examples ([AutoML](https://github.com/adavarski/h2o-jupyter-automl-docker/blob/main/h2o-AutoML-example.ipynb), [notebooks](https://github.com/adavarski/h2o-jupyter-automl-docker/tree/main/notebooks))
